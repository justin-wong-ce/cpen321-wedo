...
public class MapsPlotRouteActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private int BIKING = 3;
    private int TRANSIT = 4;
...
//        map.addMarker(new MarkerOptions().position(toronto).title("My Hometown"));
            ...
            public void onSuccess() {
                ...
                try {
                    for (int i = 0; i < routesArray.length(); i++) {
                        ...
                        polylines[i] = map.addPolyline(new PolylineOptions().add(plotCoors));
                    }
                }
                catch (Exception e) {
